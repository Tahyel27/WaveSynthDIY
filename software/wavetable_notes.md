1. Implement a wavetable oscillator in both julia and the pico synth
2. research what the x coordinate in the fft means
3. test out aliasing in julia by playing the bandlimited signal
